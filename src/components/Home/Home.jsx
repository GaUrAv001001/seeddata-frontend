...
//   return (
//     <>
//         <h1 className="text-3xl font-bold justify-center flex mt-6 mb-4 text-[#2733b8]">Transaction List</h1>
...
//       <h1 className="flex justify-center mt-20 font-bold text-3xl text-[#2733b8]">Performance Dashboard</h1>
//       {/* <h1 className="flex justify-center mt-20 font-bold text-3xl text-gray-800 border-b-2 border-gray-300 pb-2">Performance Dashboard</h1> */}
...
export default function TransactionList() {
  ...
  return (
    <>
      ...
      <div className="container mx-auto p-6 bg-white shadow-lg rounded-lg">
        <div className="mb-4 flex flex-col md:flex-row items-center">
          <input
            ...
            value={search}
            onChange={handleSearchChange}
            className="border border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 w-full md:w-auto"
          />
          <select
            value={month}
            onChange={handleMonthChange}
            className="border border-gray-300 p-2 rounded-md mt-4 md:mt-0 md:ml-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 w-full md:w-auto"
          >
            <option value="january">January</option>
            <option value="february">February</option>
            <option value="march">March</option>
      ...
      <div className="flex flex-col md:flex-row justify-center mt-6 space-y-6 md:space-x-4 p-6">
